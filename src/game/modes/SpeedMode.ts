...
export class SpeedMode extends GameMode {
    ...
    private readonly TIMEOUT_MS = 15000; // 15 seconds per shot
    private readonly FIRST_SHOT_TIMEOUT_MS = 120000; // 2 min buffer for loading
    private firstShotTaken: boolean = false;

    // Speed Mode state fields
    private gameStartTime: number = 0;
    private turnStartTime: number = 0;
    private readonly GAME_DURATION_MS = 180000; // 180 seconds overall game clock
