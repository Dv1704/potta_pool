...
describe('PaymentService (Korapay)', () => {
        ...
        const module = await Test.createTestingModule({
            providers: [
                ...
                },
                {
                    ...
                    useValue: {
                        get: jest.fn((key) => {
                            if (key === 'KORA_SECRET_KEY') return TEST_SECRET;
                            if (key === 'KORA_PUBLIC_KEY') return 'test_kora_public';
                            if (key === 'KORA_WEBHOOK_HASH') return 'test_hash';
                            return null;
                        }),
                    },
                },
    ...
    it('should initialize deposit and return checkout_url', async () => {
        ...
        expect(axiosSpy).toHaveBeenCalledWith(
            expect.stringContaining('/charges/initialize'),
