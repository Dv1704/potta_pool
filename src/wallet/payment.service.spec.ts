...
describe('PaymentService (Paystack)', () => {
                ...
                },
                {
                    ...
                    useValue: {
                        get: jest.fn((key) => {
                            ...
                            if (key === 'PAYSTACK_PUBLIC_KEY') return 'test_paystack_public';
                            if (key === 'PAYSTACK_WEBHOOK_URL') return 'test_paystack_webhook';
                            return null;
                        }),
                    },
                },
    ...
    it('should initialize deposit and return authorization_url', async () => {
        ...
        expect(axiosSpy).toHaveBeenCalledWith(
            expect.stringContaining('api.paystack.co/transaction/initialize'),
