...
export class PhysicsController {
    ...
    private _fBackSpin: number = 0;

    public setBackSpin(fVal: number): void {
    ...
    private _addBackSpinEffect(oBall: Ball, iValue: number, vRayCollision: Vector2, vDirInvert: Vector2): number {
        ...
        if (iValue === 0) {
            ...
            const iEffectForce = PhysicsUtils.linearFunction(
                iValue,
    ...
    private _addSideSpinEffect(vReflectedDir: Vector2, fRatio: number, oPerpendicularVector: Vector2, oBall: Ball): void {
        ...
        const fRatioForce = PhysicsUtils.linearFunction(
            iBallForce,
