...
export class PoolEngine {
    ...
    public executeShot(angle: number, power: number, sideSpin: number, backSpin: number, cueBallX?: number, cueBallY?: number): ShotResult {
            ...
            if (frames % 2 === 0) {
                ...
                for (const ball of this._balls) {
                    if (ball.isBallOnTable()) {
                        ...
                        if (ball.getVelocity().length2() > 0.001) hasMovement = true;
                    }
                }
