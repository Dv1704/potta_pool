...
describe('Auth & User System (E2E)', () => {
    ...
    const emailServiceMock = {
        sendPasswordResetEmail: jest.fn<any>().mockResolvedValue({ id: 'mock-id' }),
    };
    ...
    it('/auth/forgot-password (POST) - Request token', async () => {
        ...
        const args = (emailServiceMock.sendPasswordResetEmail as any).mock.calls[0];
        expect(args[0]).toBe(testUserEmail);
        resetToken = args[1] as string;
